...
\cvitem{Full-time engineering Student at the University of Michigan pursing degrees in Computer Science and Physics.}
\end{cvitems}}
\cventry
...
\cvsection{Hobbies}
\begin{cventries}
\hobby{Music Performance and Recording:~}{Played rock and jazz drumset for over 20 years. Recorded full-length album for local band.}\\
\hobby{Renovation:~}{Rennovated two homes resulting in a 200\% and 400\% increase in value. respectively. Drew plans, made all material selections, and performed various rough and finish carpentry, electrical, and plumbing work.}\\
\end{cventries}
\end{hobbies}
\end{cv}
\makefooter
